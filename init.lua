...
-- Minimal number of screen columns to keep from the right side of the screen.
...
vim.o.tabstop = 4
-- Optional, if you want files with tabs to look the same too.
vim.o.shiftwidth = 4
  ...
  },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        -- If it gives problems during the installation run "sudo apt-get install python3.12-venv"
        'ruff',
        'pyrefly',
        'isort',
    ...
    opts = {
      ...
      highlight = {
        ...
        disable = function(lang, bufnr)
          ...
          -- example: disable for very large files
